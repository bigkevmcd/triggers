...
func (in *EventInterceptor) DeepCopyInto(out *EventInterceptor) {
	*out = *in
	...
	if in.FormDecode != nil {
		in, out := &in.FormDecode, &out.FormDecode
		*out = new(FormDecodeInterceptor)
		**out = **in
	}
	return
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *FormDecodeInterceptor) DeepCopyInto(out *FormDecodeInterceptor) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new FormDecodeInterceptor.
func (in *FormDecodeInterceptor) DeepCopy() *FormDecodeInterceptor {
	if in == nil {
		return nil
	}
	out := new(FormDecodeInterceptor)
